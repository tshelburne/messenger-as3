	...
	public class SystemMessageManager implements ISystemMessageManager {
		...
		*=========================================================*/
		...
		public function queueMessage(type:String, message:String, options:Object):void {
			Debug.out("Adding '" + type + "' message to the queue...", Debug.ACTIONS, _debugOptions);
		...
		public function removeMessage(message:IMessage):void {
			Debug.out("Removing '" + message.type + "' message from the queue...", Debug.ACTIONS, _debugOptions);
		...
		private function displayMessage(message:IMessage):void {
			Debug.out("Displaying '" + message.type + "' message...", Debug.ACTIONS, _debugOptions);
		...
		private function messageDismissed(message:IMessage):void {
			Debug.out("Dismissing '" + message.type + "' message...", Debug.ACTIONS, _debugOptions);
		}
		...
		private function queueFinished():void {
			Debug.out("Message queue finished...", Debug.ACTIONS, _debugOptions);
			_clearView.dispatch();
		}
	}
}